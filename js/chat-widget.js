...
(function () {
  ...
  wrapper.innerHTML = [
    ...
    '      <strong>Thinking about buying or selling your home?</strong><br>',
    '      Chat with a local licensed agent right now — we know your neighborhood and can help you every step of the way. 🏡',
    '    </div>',
